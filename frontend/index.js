                         ...
                         data-parent="#accordion">
                          <div class="card-body">
                            <ul id="genre-game-list" class="${
                              ...
                              ${generateGameMarkup(genreGames, genreObj)}
                            </ul>
                          </div>
                        </div>
                      </div>`;
...
const generateGameMarkup = (gameArr, genreObj) => {
...
const gameLength = document.getElementById('create-game-lenght-text');
const playedCheckbox = document.getElementById('create-game-played-check');
const createMovieBtn = document.getElementById('create-game-btn');
